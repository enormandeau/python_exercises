...
NOTE:
    ...
    easier in Bash, so Mac and Linux users will have it easier.
...
LEARN:
    ...
    you give instructions to Bash on the first line of the script that tells it
    what interpreter to use. We use a line beginning with `#!`, also known as
    *shebang*, followed by the interpreter to use.
    ...
    of your script is going to want to use. They may have anaconda or miniconda
    or another Python interpreter installed.
